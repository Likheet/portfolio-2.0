...
const COLORS = [
    {
        bg: 'bg-portfolio-cream',
        text: 'text-portfolio-text',
        muted: 'text-portfolio-text/60',
        border: 'border-portfolio-text/10',
        hoverBorder: 'hover:border-portfolio-text/30',
    },
    {
        bg: 'bg-portfolio-red',
        text: 'text-portfolio-cream',
        muted: 'text-portfolio-cream/60',
        border: 'border-portfolio-cream/10',
        hoverBorder: 'hover:border-portfolio-cream/30',
    },
    {
        bg: 'bg-portfolio-text',
        text: 'text-portfolio-cream',
        muted: 'text-portfolio-cream/60',
        border: 'border-portfolio-cream/10',
        hoverBorder: 'hover:border-portfolio-cream/30',
        ...
        >
            ...
            <div className="relative z-10 flex flex-col justify-between h-full p-8 md:p-10 pointer-events-none">
                ...
                <div className="flex justify-between items-start">
                    <span
                        className={`font-inter font-bold text-6xl md:text-7xl ${theme.text} opacity-25 group-hover:opacity-40 transition-opacity duration-500 leading-none -ml-1 select-none`}
                    >
                    ...
                    <div className="flex items-center gap-2 opacity-0 -translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                        <span
                            className={`font-mono text-xs font-medium ${theme.muted} border ${theme.border} px-3 py-1.5 rounded-full`}
                        >
                            {project.year}
                        </span>
                        <div
                ...
                <div className="flex flex-col justify-end">
                    ...
                    <div className="transform transition-transform duration-500 ease-out group-hover:-translate-y-2">
                        <h3
                            className={`text-3xl md:text-4xl lg:text-5xl font-inter font-bold ${theme.text} leading-[1.1] tracking-tight mb-2`}
                        >
                            {project.title}
                        </h3>
                    </div>
